		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My Sap Semantic Page",
									"targetURL": "#commysapmysapsemanticpage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commysapmysapsemanticpage-display": {
								"semanticObject": "commysapmysapsemanticpage",
								"action": "display",
								"description": "A Fiori application based on Semantic Page",
								"title": "My Sap Semantic Page",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mysap.mysapsemanticpage",
									"url": sap.ui.require.toUrl("com/mysap/mysapsemanticpage")
								}
							}
						}
					}
